...
# 
#   m.all1 <- glmmPQL(OilYield ~ cbMEI+ PHOSROCK_year+DAP_year+UREA_EE_BULK_year+POTASH_year+factor(State)+
#                   CPO_PriceUSD_year+
...
#####overall 
tiff(file = "~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/Overall MEIv2RR1.tiff", width = 3000, height = 2500, res = 300)
...
write.csv(pred$matfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/MEI_lagestRR1.csv")
write.csv(pred$matse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/MEI_lagseRR1.csv")
write.csv(pred$cumfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/MEI_cumestRR1.csv")
write.csv(pred$cumse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/MEI_cumseRR1.csv")
...
m.all1 <- glmmPQL(OilYield ~ cbabNino1_2+ PHOSROCK_year+DAP_year+UREA_EE_BULK_year+POTASH_year+factor(State)+
                CPO_PriceUSD_year+
                NER_year+cases+factor(lockdown)+CPI_Overall_year+
                soil_category2021new2+soil_category2021new3+soil_category2021new4+soil_category2021new5+
                AAP_lag1yr_catnew2+AAP_lag1yr_catnew3+AAP_lag1yr_catnew4+AAP_lag1yr_catnew5+
...
#####overall 
tiff(file = "~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/Overall abNino1_2v2RR1.tiff", width = 3000, height = 2500, res = 300)
...
write.csv(pred$matfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino1_2_lagestRR1.csv")
write.csv(pred$matse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino1_2_lagseRR1.csv")
write.csv(pred$cumfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino1_2_cumestRR1.csv")
write.csv(pred$cumse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino1_2_cumseRR1.csv")
...
m.all1 <- glmmPQL(OilYield ~ cbabNino34+ PHOSROCK_year+DAP_year+UREA_EE_BULK_year+POTASH_year+factor(State)+
                CPO_PriceUSD_year+
                NER_year+cases+factor(lockdown)+CPI_Overall_year+
                soil_category2021new2+soil_category2021new3+soil_category2021new4+soil_category2021new5+
                AAP_lag1yr_catnew2+AAP_lag1yr_catnew3+AAP_lag1yr_catnew4+AAP_lag1yr_catnew5+
...
#####overall 
tiff(file = "~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/Overall abNino34v2RR1.tiff", width = 3000, height = 2500, res = 300)
...
write.csv(pred$matfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino34_lagestRR1.csv")
write.csv(pred$matse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino34_lagseRR1.csv")
write.csv(pred$cumfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino34_cumestRR1.csv")
write.csv(pred$cumse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino34_cumseRR1.csv")
...
m.all1 <- glmmPQL(OilYield ~ cbONI+ PHOSROCK_year+DAP_year+UREA_EE_BULK_year+POTASH_year+factor(State)+
                CPO_PriceUSD_year+
                NER_year+cases+factor(lockdown)+CPI_Overall_year+
                soil_category2021new2+soil_category2021new3+soil_category2021new4+soil_category2021new5+
                AAP_lag1yr_catnew2+AAP_lag1yr_catnew3+AAP_lag1yr_catnew4+AAP_lag1yr_catnew5+
...
#####overall 
tiff(file = "~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/Overall ONIv2RR1.tiff", width = 3000, height = 2500, res = 300)
...
write.csv(pred$matfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/ONI_lagestRR1.csv")
write.csv(pred$matse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/ONI_lagseRR1.csv")
write.csv(pred$cumfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/ONI_cumestRR1.csv")
write.csv(pred$cumse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/ONI_cumseRR1.csv")
...
m.all1 <- glmmPQL(OilYield ~ cbSOI+ PHOSROCK_year+DAP_year+UREA_EE_BULK_year+POTASH_year+factor(State)+
                CPO_PriceUSD_year+
                NER_year+cases+factor(lockdown)+CPI_Overall_year+
                soil_category2021new2+soil_category2021new3+soil_category2021new4+soil_category2021new5+
                AAP_lag1yr_catnew2+AAP_lag1yr_catnew3+AAP_lag1yr_catnew4+AAP_lag1yr_catnew5+
...
#####overall 
tiff(file = "~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/Overall SOIv2RR1.tiff", width = 3000, height = 2500, res = 300)
...
write.csv(pred$matfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/SOI_lagestRR1.csv")
write.csv(pred$matse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/SOI_lagseRR1.csv")
write.csv(pred$cumfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/SOI_cumestRR1.csv")
write.csv(pred$cumse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/SOI_cumseRR1.csv")
...
m.all1 <- glmmPQL(OilYield ~ cbBEST+ PHOSROCK_year+DAP_year+UREA_EE_BULK_year+POTASH_year+factor(State)+
                CPO_PriceUSD_year+
                NER_year+cases+factor(lockdown)+CPI_Overall_year+
                soil_category2021new2+soil_category2021new3+soil_category2021new4+soil_category2021new5+
                AAP_lag1yr_catnew2+AAP_lag1yr_catnew3+AAP_lag1yr_catnew4+AAP_lag1yr_catnew5+
...
#####overall 
tiff(file = "~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/Overall BESTv2RR1.tiff", width = 3000, height = 2500, res = 300)
...
write.csv(pred$matfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/BEST_lagestRR1.csv")
write.csv(pred$matse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/BEST_lagseRR1.csv")
write.csv(pred$cumfit,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/BEST_cumestRR1.csv")
write.csv(pred$cumse,file="~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/BEST_cumseRR1.csv")
