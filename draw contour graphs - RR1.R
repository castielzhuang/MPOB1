result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/FFBYield/main/abNino1_2_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/FFBYield/main/abNino34_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/FFBYield/main/BEST_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/FFBYield/main/MEI_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/FFBYield/main/ONI_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/FFBYield/main/SOI_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/AverageOER/main/abNino1_2_lagestRR1.csv")
max(result[2:12])
min(result[2:12])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/AverageOER/main/abNino34_lagestRR1.csv")
max(result[2:12])
min(result[2:12])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/AverageOER/main/BEST_lagestRR1.csv")
max(result[2:12])
min(result[2:12])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/AverageOER/main/MEI_lagestRR1.csv")
max(result[2:12])
min(result[2:12])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/AverageOER/main/ONI_lagestRR1.csv")
max(result[2:12])
min(result[2:12])
...
par(mai=c(1,1,1,1),lwd=2)
filled.contour(x = result$X, y = 0:10, z = as.matrix(result[2:12]), zlim = range(-0.1,0.1), nlevels = 100, color.palette = colorRampPalette(c("DeepSkyBlue4","White","Red3")), key.axes =axis(4, seq(-0.1,0.1,by=0.1), cex.axis=2.5), plot.axes={
  axis(1,cex.axis=3)
  axis(2,cex.axis=3)
},plot.title={
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/AverageOER/main/SOI_lagestRR1.csv")
max(result[2:12])
min(result[2:12])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino1_2_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/abNino34_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/BEST_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/MEI_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/ONI_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
...
result<-read.csv("~/Downloads/dataset 20231014/Study Sample/dataset/results/OilYield/main/SOI_lagestRR1.csv")
max(result[2:25])
min(result[2:25])
